...
wpui <- ts(y$G15.5, start = 1996, end = 2020) # Pandemic Uncertainty in G15
unemp <- ts(y$G15, start = 1996, end = 2020) # Unemployment in G15
gdp <- ts(y$G15.1, start = 1996, end = 2020) # GDP in G15

lwip <- ts(y$LWIP, start = 1996, end = 2020)
lgpr <- ts(y$LGPR, start = 1996, end = 2020)

wui <- ts(y$G15.4, start = 1996, end = 2020) #Uncertainty in G15
cpi <- ts(y$G15.2, start = 1996, end = 2020) # Inflation in G15
