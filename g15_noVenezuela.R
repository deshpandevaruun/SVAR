...
library(tseries)
library(ggfortify)
y <- read.csv("g15_NoVenezuela.csv")
...
wpui <- ts(y$WPUI, start = 1996, end = 2020)

lwip <- ts(y$LWIP, start = 1996, end = 2020)
lgpr <- ts(y$LGPR, start = 1996, end = 2020)
unemp <- ts(y$Unemp, start = 1996, end = 2020) # Unemployment in G15
gdp <- ts(y$GDP, start = 1996, end = 2020) # GDP in G15
cpi <- ts(y$CPI, start = 1996, end = 2020)

wui <- ts(y$WUI, start = 1996, end = 2020)
